...
/**
 * Configuration class providing an HTTP/HTTPS implementation of the {@link CampaignuploadCampaignuploadClient }.
 * 
 * <p>Conditional on:</p>
 * <ul>
 * <li><strong>There being no other implementation of the {@link CampaignuploadCampaignuploadClient }
 *     interface in the application context</strong>.
 *     (Therefore, if the service configures its own {@link CampaignuploadCampaignuploadClientHttpImpl } to use, the instance configured here
 *     will be ignored.)
...
@Configuration("com.backbase.campaignupload.listener.client.v1.campaignupload.CampaignuploadCampaignuploadClientHttpImplAutoConfiguration")
@ConfigurationProperties("backbase.communication.services.campaignupload")
public class CampaignuploadCampaignuploadClientHttpImplAutoConfiguration {
    ...
    @Bean("com.backbase.campaignupload.listener.client.v1.campaignupload.CampaignuploadCampaignuploadClient")
    @ConditionalOnBean(name = "interServiceRestTemplate")
    public CampaignuploadCampaignuploadClient createClient(
        ...
        CampaignuploadCampaignuploadClientHttpImpl clientInstance = new CampaignuploadCampaignuploadClientHttpImpl(restTemplate, serviceId, ((scheme == null)?defaultScheme:scheme), objectMapper, internalRequestContext);
