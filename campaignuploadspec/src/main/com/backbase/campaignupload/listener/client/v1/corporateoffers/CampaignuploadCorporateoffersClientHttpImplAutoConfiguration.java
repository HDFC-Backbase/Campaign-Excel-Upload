...
/**
 * Configuration class providing an HTTP/HTTPS implementation of the {@link CampaignuploadCorporateoffersClient }.
 * 
 * <p>Conditional on:</p>
 * <ul>
 * <li><strong>There being no other implementation of the {@link CampaignuploadCorporateoffersClient }
 *     interface in the application context</strong>.
 *     (Therefore, if the service configures its own {@link CampaignuploadCorporateoffersClientHttpImpl } to use, the instance configured here
 *     will be ignored.)
...
@Configuration("com.backbase.campaignupload.listener.client.v1.corporateoffers.CampaignuploadCorporateoffersClientHttpImplAutoConfiguration")
@ConfigurationProperties("backbase.communication.services.campaignupload")
public class CampaignuploadCorporateoffersClientHttpImplAutoConfiguration {
    ...
    @Bean("com.backbase.campaignupload.listener.client.v1.corporateoffers.CampaignuploadCorporateoffersClient")
    @ConditionalOnBean(name = "interServiceRestTemplate")
    public CampaignuploadCorporateoffersClient createClient(
        ...
        CampaignuploadCorporateoffersClientHttpImpl clientInstance = new CampaignuploadCorporateoffersClientHttpImpl(restTemplate, serviceId, ((scheme == null)?defaultScheme:scheme), objectMapper, internalRequestContext);
