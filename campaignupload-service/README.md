...
- `java -jar target/campaignupload-service-1.0.0-SNAPSHOT.jar`
...
The official campaignupload-service support room is [#s-campaignupload-service](https://todo).
